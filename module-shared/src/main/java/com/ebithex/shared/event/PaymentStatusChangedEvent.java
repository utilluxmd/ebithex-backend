...
/**
 * Événement domaine publié à chaque changement de statut de transaction.
 *
 * L'événement est auto-portant (contient les montants) pour éviter
 * que les consommateurs (Wallet, Notification) aient à requêter la DB.
 *
 * Consommateurs :
 *  - WalletService      : crédite le marchand sur SUCCESS
